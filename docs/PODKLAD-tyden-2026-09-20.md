...
2. **Právě čeká na Karla:** `/nahled` obsahuje **30 nových úloh L3 ve stylu CERMAT (Zlomky 10, Výrazy 10, Rovnice 10)** — potřebuji „schvaluji" (nebo připomínky), pak zápis do ostré DB.
...
| Zlomky | (starší) | (starší) | ⏳ **10 v náhledu** | 4 vlastní SVG (nádrž, vnořené čtverce, číselná osa, koláč) |
| Výrazy | (starší) | (starší) | ⏳ **10 v náhledu** | 2 vlastní SVG + 1 úloha s KaTeX |
| Rovnice | (starší) | (starší) | ⏳ **10 v náhledu** | 2 vlastní SVG (váhy, obdélník) |
